...
const run = require("../../../../bin/builder-core");

const base = require("../base.spec");

// Cross-platform shell command strings and environment variables.
const CLI_SLEEP = "node -e \"setTimeout(function () {}, 10000);\"";
const IS_WIN = (/^win/).test(process.platform);
const ENV_MY_VAR = IS_WIN ? "%MY_VAR%" : "$MY_VAR";
const ENV_PROC_NUM = IS_WIN ? "%PROC_NUM%" : "$PROC_NUM";
const ECHO = "node test/fixtures/echo.js";
const ECHO_FOREVER = "node test/fixtures/echo-forever.js";
const REPEAT = "node test/fixtures/repeat.js";
const FAIL = "node test/fixtures/fail.js";

// Custom test runners.
const itSkipWin = (IS_WIN ? it.skip : it).bind(it);
...
const readFiles = function (callback, done) {
  base.mockFs.restore();

  fs.readdir(process.cwd(), (readdirErr, files) => {
    if (readdirErr) { return done(readdirErr); }

    const obj = {};
    const outs = files.filter(base.isTestOuts);
...
// Single file alias.
const readFile = function (filename, callback, done) {
  readFiles((obj) => {
...
describe("bin/builder-core", () => {
  let logStubs;

  beforeEach(() => {
    const debugSpy = base.sandbox.spy();
    logStubs = {
    ...
    base.sandbox.stub(Config.prototype, "_lazyRequire", (mod) => {
    ...
    base.sandbox.stub(Task.prototype, "_lazyRequire", (mod) => {
      const lookup = {
        "./utils/setup": setup
      };
  ...
  describe("builder --version", () => {
    it("runs version", stdioWrap((done) => {
  ...
  describe("builder help", () => {
    it("runs help with no arguments", stdioWrap((done) => {
    ...
    it("runs help with `builder run` alone", stdioWrap((done) => {
      base.sandbox.spy(Task.prototype, "help");
      base.mockFs({
        "package.json": "{}"
      });
    ...
    it("runs help with flags", stdioWrap((done) => {
      base.sandbox.spy(Task.prototype, "help");
    ...
    it("runs help for run command", stdioWrap((done) => {
      base.sandbox.spy(Task.prototype, "help");
      base.mockFs({
        "package.json": "{}"
      });
    ...
    it("runs help with config in archetype", stdioWrap((done) => {
      base.sandbox.spy(Task.prototype, "help");
      base.mockFs({
        ".builderrc": "---\narchetypes:\n  - mock-archetype",
        "package.json": "{}",
  ...
  describe("builder run", () => {
    it("runs a <root>/package.json command", (done) => {
      base.sandbox.spy(Task.prototype, "run");
      base.mockFs({
        "package.json": JSON.stringify({
          scripts: {
      ...
      run({
        ...
        readFile("stdout.log", (data) => {
          expect(data).to.contain("BAR_TASK");
        }, done);
      });
    });

    it("runs with quiet log output", (done) => {
      base.sandbox.spy(Task.prototype, "run");
      base.mockFs({
        "package.json": JSON.stringify({
          scripts: {
    ...
    it("runs with specified log level", (done) => {
      base.sandbox.spy(Task.prototype, "run");
      base.mockFs({
        "package.json": JSON.stringify({
          scripts: {
      ...
      run({
        ...
        readFile("stderr.log", (data) => {
          expect(data).to.contain("BAD_COMMAND");
        }, done);
      });
    });

    it("runs an <archetype>/package.json command", (done) => {
      base.sandbox.spy(Task.prototype, "run");
      base.mockFs({
        ".builderrc": "---\narchetypes:\n  - mock-archetype",
        "package.json": "{}",
    ...
    it("ignores archetype builder:-prefaced tasks", () => {
      base.mockFs({
        ".builderrc": "---\narchetypes:\n  - mock-archetype",
        "package.json": "{}",
        node_modules: {
    ...
    it("overrides a <archetype> command with a <root> one", (done) => {
      base.sandbox.spy(Task.prototype, "run");
      base.mockFs({
        ".builderrc": "---\narchetypes:\n  - mock-archetype",
        "package.json": JSON.stringify({
    ...
    it("runs --setup without flags --expand-archetype", (done) => {
      base.sandbox.spy(Task.prototype, "run");
      base.mockFs({
        ".builderrc": "---\narchetypes:\n  - mock-archetype",
    ...
    it("runs --setup with flags --env", (done) => {
      base.sandbox.spy(Task.prototype, "run");
      base.mockFs({
        ".builderrc": "---\narchetypes:\n  - mock-archetype",
        "package.json": JSON.stringify({}, null, 2),
    ...
    it("runs --setup without custom flags", (done) => {
      base.sandbox.spy(Task.prototype, "run");
      base.mockFs({
        ".builderrc": "---\narchetypes:\n  - mock-archetype",
        "package.json": JSON.stringify({}, null, 2),
    ...
    it("handles --setup early 0 exit", (done) => {
      base.sandbox.spy(Task.prototype, "run");
      base.mockFs({
        "package.json": JSON.stringify({
          scripts: {
    ...
    it("handles --setup early 1 exit", (done) => {
      base.sandbox.spy(Task.prototype, "run");
      base.mockFs({
        "package.json": JSON.stringify({
          scripts: {
    ...
    it("runs with --env-path value", (done) => {
      base.sandbox.spy(Task.prototype, "run");
      base.mockFs({
        "package.json": JSON.stringify({
          scripts: {
    ...
    it("runs with empty string --env value", (done) => {
      base.sandbox.spy(Task.prototype, "run");
      base.mockFs({
        "package.json": JSON.stringify({
          scripts: {
    ...
    it("runs with empty string --env-path value", (done) => {
      base.sandbox.spy(Task.prototype, "run");
      base.mockFs({
        "package.json": JSON.stringify({
          scripts: {
    ...
    it("runs with base config value", (done) => {
      base.sandbox.spy(Task.prototype, "run");
      base.mockFs({
        "package.json": JSON.stringify({
          config: {
    ...
    it("runs with archetype config value", (done) => {
      base.sandbox.spy(Task.prototype, "run");
      base.mockFs({
        ".builderrc": "---\narchetypes:\n  - mock-archetype",
        "package.json": "{}",
    ...
    itSkipWin("runs with empty base + non-empty archetype config value", (done) => {
      base.sandbox.spy(Task.prototype, "run");
      base.mockFs({
        ".builderrc": "---\narchetypes:\n  - mock-archetype",
        "package.json": JSON.stringify({
    ...
    it("runs with real ENV overriding archetype config value", (done) => {
      base.sandbox.spy(Task.prototype, "run");
      base.mockFs({
        ".builderrc": "---\narchetypes:\n  - mock-archetype",
        "package.json": "{}",
    ...
    it("runs with real ENV overriding base + archetype config values", (done) => {
      base.sandbox.spy(Task.prototype, "run");
      base.mockFs({
        ".builderrc": "---\narchetypes:\n  - mock-archetype",
        "package.json": JSON.stringify({
    ...
    it("runs with --env overriding base + archetype config values", (done) => {
      base.sandbox.spy(Task.prototype, "run");
      base.mockFs({
        ".builderrc": "---\narchetypes:\n  - mock-archetype",
        "package.json": JSON.stringify({
    ...
    describe("expands paths with --expand-archetype", () => {
      it("skips `../node_modules/<archetype>`", (done) => {
        base.sandbox.spy(Task.prototype, "run");
        base.mockFs({
          ".builderrc": "---\narchetypes:\n  - mock-archetype",
          "package.json": JSON.stringify({}, null, 2),
      ...
      it("skips `other/node_modules/<archetype>`", (done) => {
        base.sandbox.spy(Task.prototype, "run");
        base.mockFs({
          ".builderrc": "---\narchetypes:\n  - mock-archetype",
          "package.json": JSON.stringify({}, null, 2),
      ...
      it("replaces `node_modules/<archetype>`", (done) => {
        base.sandbox.spy(Task.prototype, "run");
        base.mockFs({
          ".builderrc": "---\narchetypes:\n  - mock-archetype",
          "package.json": JSON.stringify({}, null, 2),
      ...
      it("propagates flag to sub-task", (done) => {
        base.sandbox.spy(Task.prototype, "run");
        base.mockFs({
          ".builderrc": "---\narchetypes:\n  - mock-archetype",
          "package.json": JSON.stringify({}, null, 2),
      ...
      it("skips replacing root project tasks", (done) => {
        base.sandbox.spy(Task.prototype, "run");
        base.mockFs({
          ".builderrc": "---\narchetypes:\n  - mock-archetype",
          "package.json": JSON.stringify({
    ...
    describe("pre/post lifecycle", () => {
      it("runs pre archetype task and post root task", (done) => {
        base.sandbox.spy(Task.prototype, "run");
        base.mockFs({
          ".builderrc": "---\narchetypes:\n  - mock-archetype",
          "package.json": JSON.stringify({
      ...
      it("only passes custom flags to main task", (done) => {
        base.sandbox.spy(Task.prototype, "run");
        base.mockFs({
          ".builderrc": "---\narchetypes:\n  - mock-archetype",
          "package.json": JSON.stringify({
      ...
      it("passes --env flags to pre+post tasks", (done) => {
        base.sandbox.spy(Task.prototype, "run");
        base.mockFs({
          "package.json": JSON.stringify({
            scripts: {
      ...
      it("passes --env-path flags to pre+post tasks", (done) => {
        base.sandbox.spy(Task.prototype, "run");
        base.mockFs({
          "env.json": JSON.stringify({
            TEST_MESSAGE: "from --env"
      ...
      it("passes --quiet flags to pre+post tasks", (done) => {
        base.sandbox.spy(Task.prototype, "run");
        base.mockFs({
          "package.json": JSON.stringify({
            scripts: {
      ...
      it("passes --log-level to pre+post tasks", (done) => {
        base.sandbox.spy(Task.prototype, "run");
        base.mockFs({
          "package.json": JSON.stringify({
            scripts: {
      ...
      it("passes --expand-archetype flags to pre+post tasks", (done) => {
        base.sandbox.spy(Task.prototype, "run");
        base.mockFs({
          ".builderrc": "---\narchetypes:\n  - mock-archetype",
          "package.json": JSON.stringify({}, null, 2),
        ...
        run({
          ...
          readFiles((obj) => {
            const ARCH_PATH = path.resolve("node_modules/mock-archetype");
      ...
      it("skips --tries flag in pre+post tasks", (done) => {
        base.sandbox.spy(Task.prototype, "run");
        base.mockFs({
          "package.json": JSON.stringify({
            scripts: {
      ...
      it("does not apply pre+post tasks for a --setup task", (done) => {
        base.sandbox.spy(Task.prototype, "run");
        base.mockFs({
          "package.json": JSON.stringify({
            scripts: {
      ...
      it("skips prepost, postpost tasks", (done) => {
        base.sandbox.spy(Task.prototype, "run");
        base.mockFs({
          "package.json": JSON.stringify({
            scripts: {
      ...
      it("skips prepre, postpre tasks", (done) => {
        base.sandbox.spy(Task.prototype, "run");
        base.mockFs({
          "package.json": JSON.stringify({
            scripts: {
  ...
  describe("builder concurrent", () => {
    it("runs <root>/package.json concurrent commands", (done) => {
    ...
    it("runs <archetype>/package.json concurrent commands", (done) => {
      base.sandbox.spy(Task.prototype, "concurrent");
      base.mockFs({
        ".builderrc": "---\narchetypes:\n  - mock-archetype",
        "package.json": JSON.stringify({
    ...
    it("runs with --setup, --queue", (done) => {
      ...
      run({
        ...
        // Verify through logs.
        const setupTaskStarts = logStubs.debug.args
          .filter((arg) => (arg[0] || "").indexOf("Starting setup task") > -1);
    ...
    it("runs with base overriding archetype config value", (done) => {
      base.sandbox.spy(Task.prototype, "concurrent");
      base.mockFs({
        ".builderrc": "---\narchetypes:\n  - mock-archetype",
        "package.json": JSON.stringify({
    ...
    describe("pre/post lifecycle", () => {
      it("runs mixed pre and post tasks", (done) => {
        base.mockFs({
          ".builderrc": "---\narchetypes:\n  - mock-archetype",
          "package.json": JSON.stringify({
            scripts: {
      ...
      it("completes non-error tasks with --bail=false when pre task fails", (done) => {
        base.mockFs({
          ".builderrc": "---\narchetypes:\n  - mock-archetype",
          "package.json": JSON.stringify({
            scripts: {
      ...
      it("early terminates all tasks with --bail=false when --setup task fails", (done) => {
        base.mockFs({
          ".builderrc": "---\narchetypes:\n  - mock-archetype",
          "package.json": JSON.stringify({
            scripts: {
    ...
    it("applies --buffer flag in pre+post tasks", (done) => {
  ...
  describe("builder envs", () => {
    it("runs <root>/package.json multiple env commands", (done) => {
    ...
    it("runs multiple env commands with --buffer, --envs-path", (done) => {
      base.sandbox.spy(Task.prototype, "envs");
    ...
    it("runs <archetype>/package.json multiple env commands", (done) => {
      base.sandbox.spy(Task.prototype, "envs");
    ...
    it("overrides <archetype>/package.json multiple env commands", (done) => {
      base.sandbox.spy(Task.prototype, "envs");
    ...
    it("errors on empty JSON array", (done) => {
      base.sandbox.spy(Task.prototype, "envs");
      base.mockFs({
        "package.json": JSON.stringify({
          scripts: {
    ...
    it("errors on empty JSON non-array", (done) => {
      base.sandbox.spy(Task.prototype, "envs");
      base.mockFs({
        "package.json": JSON.stringify({
          scripts: {
    ...
    it("errors on malformed JSON array", (done) => {
      base.sandbox.spy(Task.prototype, "envs");
      base.mockFs({
        "package.json": JSON.stringify({
          scripts: {
    ...
    it("errors on nonexistent JSON file", (done) => {
      base.sandbox.spy(Task.prototype, "envs");
      base.mockFs({
        "package.json": JSON.stringify({
          scripts: {
    ...
    it("runs with --tries=2, --queue=1, --bail=false", (done) => {
      base.sandbox.spy(Task.prototype, "envs");
    ...
    it("runs with envs overriding base config value", (done) => {
      base.sandbox.spy(Task.prototype, "envs");
    ...
    it("runs with envs real ENV overriding base + arch config value", (done) => {
      base.sandbox.spy(Task.prototype, "envs");
    ...
    it("runs with envs overriding --env value", (done) => {
      base.sandbox.spy(Task.prototype, "envs");
    ...
    it("runs with envs overriding --env-path value", (done) => {
      base.sandbox.spy(Task.prototype, "envs");
    ...
    it("skips --buffer flag in pre+post tasks", (done) => {
      base.sandbox.spy(runner, "run");
      base.sandbox.spy(Task.prototype, "envs");
      base.mockFs({
        "package.json": JSON.stringify({
