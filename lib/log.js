...
var log = module.exports = {
  ...
  setLevel: function (opts) {
    ...
    console.error("DEBUG: setLevel 001", level, log._env._BUILDER_ARGS_LOG_LEVEL); // eslint-disable-line
    ...
    console.error("DEBUG: setLevel 002", level, log._env._BUILDER_ARGS_LOG_LEVEL); // eslint-disable-line
  ...
  _wrapper: function (level, color, type, msg) { // eslint-disable-line max-params
    ...
    console.error("DEBUG: _wrapper", level, log._level, log._env._BUILDER_ARGS_LOG_LEVEL); // eslint-disable-line
