 ...
 * Environment wrapper.
 *
 * **Note**: Does not mutate environment object, but instead acts on a clone.
 *
 * @param {Object} opts         Options object
 * @param {Object} opts.config  Configuration object
 * @param {Object} opts.env     Environment object to clone (Default `process.env`)
 * @returns {void}
 */
var Environment = module.exports = function (opts) {
  opts = opts || {};
  this.config = opts.config;
  this.env = _.cloneDeep(opts.env || process.env);
